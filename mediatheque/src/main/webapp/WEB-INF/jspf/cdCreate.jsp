		...
		<section>
			...
			<form:form action="create" method="POST" modelAttribute="cd">
				...
				<div class="form-row">
			 		...
			 		<div class="form-group col">
						<form:label path="dateSortie"><spring:message code="entities.cd.dateSortie" /><span class="text-danger"><spring:message code="commons.symbols.required" /></span></form:label>
						<div class="input-group">
			 	...
			 	<div class="form-row">
			 		<div class="form-group col">
						<form:label path="description"><spring:message code="entities.cd.description" /></form:label>
						<div class="input-group">
				...
				<div class="form-row">
					<div class="form-group col">
						<div class="form-check">
							...
							<form:label path="favori" class="form-check-label" for="favori"><spring:message code="entities.cd.favori" /></form:label>
						</div>
					</div>
				</div>
				<div class="form-row">
					<div class="form-group col">
						<div class="form-check">
							...
							<form:label path="utilise" class="form-check-label" for="utilise"><spring:message code="entities.cd.utilise" /></form:label>
						</div>
					</div>
				</div>
