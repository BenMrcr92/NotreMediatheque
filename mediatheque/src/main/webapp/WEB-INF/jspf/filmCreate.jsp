	...
	<div class="container-fluid">
		<section>
			...
			<form:form action="create" method="POST" modelAttribute="film">
				...
				<div class="form-row">
					<div class="form-group col">
						<form:label path="support.name"><spring:message code="entities.film.support" /><span class="text-danger"><spring:message code="commons.symbols.required" /></span></form:label>
						<form:select path="support.name" multiple="true" cssClass="form-control" cssErrorClass="form-control is-invalid">
							<form:option value="0"><spring:message code="commons.forms.select" /></form:option>
							<form:options items="${support}" itemValue="name" itemLabel="name" />
						</form:select>
						<form:errors element="div" path="support.name" cssClass="invalid-feedback" />
					</div>
				</div>
				<div class="form-row">
					<div class="form-group col">
