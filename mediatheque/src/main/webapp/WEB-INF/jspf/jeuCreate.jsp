...
<body>
	...
	<div class="container-fluid">
		<section>
			<h1 class="text-primary text-center"><spring:message code="entities.jeu.create.title" /></h1>
			<form:form action="create" method="POST" modelAttribute="jeu">
				<div class="form-row">
					<div class="form-group col">
						<form:label path="nom"><spring:message code="entities.jeu.nom" /><span class="text-danger"><spring:message code="commons.symbols.required" /></span></form:label>
				...
				<div class="form-row">
					...
					<div class="form-group col">
						<form:label path="dateEdition"><spring:message code="entities.jeu.dateEdition" /></form:label>
						<form:input path="dateEdition" maxlength="10" placeHolder="${datePattern}" cssClass="form-control datepicker" autocomplete="off" />
					</div>
				</div>
			 	<div class="form-row">
			 		<div class="form-group col">
				...
				<div class="form-row">
					<div class="form-group col">
						<div class="form-check">
							...
							<form:label path="favori" class="form-check-label" for="favori"><spring:message code="entities.jeu.favori" /></form:label>
						</div>
					</div>
				</div>
				<div class="form-row">
					<div class="form-group col">
						<div class="form-check">
							...
							<form:label path="utilise" class="form-check-label" for="utilise"><spring:message code="entities.jeu.utilise" /></form:label>
						</div>
					</div>
				</div>
